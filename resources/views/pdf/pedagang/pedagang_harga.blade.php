...
<body>
    @php
        $firstItem = $dataDetailPengecer->first();
        $namaPasar =  $firstItem->first()->nama_pasar;
    @endphp

    <h4 class="text-center">
        DAFTAR HARGA TINGKAT PEDAGANG PENGECER <br>
        UPT {{  strtoupper($namaPasar)  }} KABUPATEN LAMONGAN
    </h4>
    ...
    <h4 class="text-center">DAFTAR PASOKAN TINGKAT PEDAGANG PENGECER <br> 
        UPT PASAR {{  strtoupper($namaPasar)  }} KABUPATEN LAMONGAN
    </h4>
    <h5 class="text-center">{{ $formattedHeaderDate }}</h5>
    ...
    <!-- Tabel Data Grosir -->
    <h4 class="text-center">DAFTAR HARGA TINGKAT PEDAGANG GROSIR <br>
        UPT {{ strtoupper($namaPasar) }} KABUPATEN LAMONGAN
    </h4>
    <h5 class="text-center">{{ $formattedFooterDate }}</h5>
