...
@section('content')
    <main class="container-fluid mt-3">
        <div class="card shadow border-0 mb-4">
            <div class="card-body">
                <h4 class="text-center">Data Pasokan Pangan Tingkat Pedagang Pengecer</h4>
        ...
        <div class="card shadow border-0 mb-4">
            <div class="card-body">
                <h4 class="text-center">Data Pasokan Pangan Tingkat Pedagang Grosir</h4>
        ...
        <div class="card shadow border-0 mb-4">
            <div class="card-body">
                <h4 class="text-center">Data Pasokan Pangan Tingkat Produsen</h4>
